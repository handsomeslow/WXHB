...
public class SPUtil {
     ...
     * @return
     */
    public static synchronized SPUtil getInstance(Context outContext) {
        if (sInstance == null) {
            sInstance = new SPUtil(outContext);
        }
        return sInstance;
    }

    private SPUtil(Context outContext) {
